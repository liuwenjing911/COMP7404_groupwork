...
img_size = 100
train_dir = 'C:\\Users\\Liu Wenjing\\Downloads\\Fruit-Images-Dataset-master\\fruit_train\\'
test_dir = 'C:\\Users\\Liu Wenjing\\Downloads\\Fruit-Images-Dataset-master\\fruit_test\\'
def get_data(folder_path):
    imgs = []
    indices = []
    labels = []
    for idx, folder_name in enumerate(os.listdir(folder_path)[:9]):
